...
<body>
    ...
    {{-- offcanvas  --}}
    <button style="float: left;background:white;border-bottom:1px solid#e1e1e1 !important;font-size:37px;border:none;" class="mx-3" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling"><i class="bi bi-list"></i></button>
 ...
 <img class="mx-5" src="images/1.jpg" alt="menu-logo" height="220px" width="250px">
  ...
  <div class="offcanvas-body">
    ...
    <div class="container-fluid my-5">
        <div class="row">
            <div class="col-md-2"> {{-- 1st col-md-2 --}}
